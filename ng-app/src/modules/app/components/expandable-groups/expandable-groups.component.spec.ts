...
describe('Components/ExpandableGroupsComponent', () => {
  ...
  it(
    'should render group content correctly',
    async(() => {
      const fixture = TestBed.createComponent(ExpandableGroupsComponent);
      const element = fixture.debugElement.nativeElement;
      const component = fixture.debugElement.componentInstance;
      ...
      expect(
        groupNode.querySelector('.expandable-group__header').textContent.trim()
      ).toEqual('Group#1');

      // Check number of group item nodes.
      const groupItemNodes = groupNode.querySelectorAll(
